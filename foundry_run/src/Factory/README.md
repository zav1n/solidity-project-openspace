...
![image](https://github.com/user-attachments/assets/2c645a8a-9488-4c36-b8cb-dd50a88669b6)

### 升级方式

#### 透明代理 (Transparent Prox) ERC-1967
![image](https://github.com/user-attachments/assets/d0f10246-4964-44e6-b9ea-13e8a9f91457)
...
![image](https://github.com/user-attachments/assets/64c1afff-26c1-439e-8b73-c14c37b33296)

支持构建可在生产中扩展的模块化智能合约系统的标准。钻石是具有多个实施合约的代理合约。

#### Beacon 代理(信标代理)
![image](https://github.com/user-attachments/assets/41d0e85a-b5b8-418e-99b8-8e3c86bfb552)
